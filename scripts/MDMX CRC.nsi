...
!define VER_MAJOR 1
!define VER_MINOR 0
!define NAME "MDMX CRC"
!define INPUT_FILE "MDMX_CRC.ofx"
!define OUT_FILE "MDMX CRC Installer.exe"
...
Section "Install"
  ...
  File "/oname=${INPUT_FILE}" "..\mdmx-ofx-fixtures\x64\Release\mdmx-crc-recalc-ofx.dll"
